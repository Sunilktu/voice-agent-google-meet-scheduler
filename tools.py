...
#     Note: api_resource is implicitly available from the imported google_calendar_api module.
#     """
#     # Use the globally available api_resource from the imported module
#     global api_resource 
