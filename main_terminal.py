...
# # #     print("Welcome to the Meeting Scheduler Bot!")
...
# # #         except Exception as e:
# # #             print(f"Bot: An error occurred: {e}. Please try again.")
...
# # from playsound import playsound # Note: playsound can be blocking, handled with asyncio.to_thread
...
# # # pip install SpeechRecognition gTTS playsound # For voice capabilities
...
# #         # Save to a temporary file, then play
...
# from pydub.playback import play # New import for pydub playback
...
# async def speak_text(text: str):
#     """Converts text to speech and plays it using gTTS and playsound."""
#     if not text:
#         return
#     print(f"Bot speaking: {text}")
#     try:
...
#         audio_file = "bot_response.mp3"
#         await asyncio.to_thread(tts.save, audio_file)
#         await asyncio.to_thread(playsound, audio_file) # Using playsound
#         os.remove(audio_file) # Clean up the temporary file
#     except Exception as e:
#         print(f"Error during text-to-speech or playback: {e}")
#         print("Please ensure playsound is correctly installed and its dependencies are met.")
